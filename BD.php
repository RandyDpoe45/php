<?php
    ...
    public $conection;
        ...
        public function crearCuentaAhorros($userId){
			$val = $GLOBALS["CuotaManejoAhorros"];
            $sql = "insert into CuentaAhorros (UserID,cuotaManejo) values ($userId,$val)";
        ...
        public function crearCreditoVisitante($cedula, $email){
            ...
            $sql = "insert into credito (cedulaVisitante,cuotaManejo) values ('$cedula',$val)";
